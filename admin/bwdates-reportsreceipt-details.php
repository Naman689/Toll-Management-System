...
?>
<h5 align="center" style="font-size: 17px; color: blue; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; " >Receipts report from <?php echo $fdate?> to <?php echo $tdate?></h5>
      <table class="table table-bordered">
        <thead>
           <tr>
            ...
            <th style="font-size: 15px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; ">Date of Creation</th>
          ...
          <tr>
            <th style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; " scope="row"><?php echo $cnt;?></th>
                ...
                <td style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; "><?php  echo $row['CreationDate'];?></td>
                  <td style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; "><a href="view-receipt.php?viewid=<?php echo $row['ID'];?>">View Details</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
