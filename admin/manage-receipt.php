...
<div id="wrapper">
     <?php include_once('includes/sidebar.php');?>
	   ...
	   <div class="xs">
  	 <h3 style="font-size: 25px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; ">Manage Receipt</h3>
    ...
    <div class="table-responsive">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th style="font-size: 15px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; ">S.NO</th>
           ...
           <th style="font-size: 15px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; ">Vehicle Number</th>
            <th style="font-size: 15px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; ">Date & Time</th>
            <th style="font-size: 15px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; ">Action</th>
            </tr>
        </thead>
        <tbody>
           <?php
...
?>
          <tr>
            <th style="font-size: 14px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; " scope="row"><?php echo $cnt;?></th>
                ...
                <td style="font-size: 13px; color: #000;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 500; "><a href="view-receipt.php?viewid=<?php echo $row['ID'];?>">View Details</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
