...
$tdate=$_POST['todate'];
?>
<h5 align="center" style="font-size: 17px; color: blue; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; " >Vehicle Receipt Count Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th style="font-size: 15px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; ">Total Vehicle Receipt</th>
                       </tr>
        </thead>
        <tbody>
           <?php
...
?>
          <tr>
            <td style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; "><?php  echo $row['lmonth']."/".$row['lyear'];?></td>
              <td style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; "><?php  echo $total=$row['totalcount'];?></td>
...
$ftotal+=$total;
 ...
 <tr>
                  <td style="font-size: 14px; color: #000; margin-left: 10px;  font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 800; ">Total </td>
